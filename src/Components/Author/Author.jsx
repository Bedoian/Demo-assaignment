...
const Author = () => {
    ...
    return (
        <div>
            <div className="flex flex-col max-w-full p-6 shadow-md rounded-xl sm:px-12 bg-gray-900 text-gray-100">
                ...
                <div className="space-y-4 text-center divide-y divide-gray-700">
                    ...
                    <div className="flex justify-center pt-2 space-x-4 align-center">
                        ...
                        target="_blank" href={`https://github.com/${github_username}`} aria-label="GitHub" className="p-2 rounded-md text-gray-100 hover:text-violet-400">
